class SkillManager {
    ...
    async loadInstalled() {
        try {
            ...
            console.warn('Failed to load skills, using demo data:', e);
            this.skills = [
                { name: 'rust-analyzer', version: '0.3.0', description: 'Rust language server integration' },
                { name: 'git-commit', version: '1.0.0', description: 'Auto-generate commit messages from diffs' },
                { name: 'code-review', version: '0.5.2', description: 'AI-powered code review assistant' },
                { name: 'test-gen', version: '0.2.1', description: 'Automatic test generation for Rust projects' },
            ];
        }
        this.renderSkills();
    }
    ...
    async loadMarketplace() {
        try {
            ...
            console.warn('Failed to load marketplace, using demo data:', e);
            this.marketplace = [
                { name: 'swagger-docs', author: 'omnicode', description: 'Auto-generate OpenAPI/Swagger docs from Rust code', downloads: 1200, rating: 4.5 },
                { name: 'db-migrate', author: 'community', description: 'Database migration generator for SQLite and PostgreSQL', downloads: 890, rating: 4.2 },
                { name: 'dockerize', author: 'omnicode', description: 'One-click Dockerfile and docker-compose generation', downloads: 2100, rating: 4.8 },
            ];
        }
