class App {
                ...
                <div id="section-desktop" style="display:${collapsedDesktop ? 'none' : ''}">
                    <div class="download-item">
                        <div class="download-item-header">
                            ...
                            <span class="download-item-size">~4 MB</span>
                        </div>
                        <button class="btn primary" onclick="app.downloadFromGitHub('omnicode-x86_64-pc-windows-msvc.zip','OmniCode-v0.1.0-windows-x86_64.zip')">Download ZIP</button>
                    </div>
                    <div class="download-item">
                        <div class="download-item-header">
                        ...
                        <button class="btn primary" onclick="app.downloadFromGitHub('omnicode-linux-amd64.tar.gz','OmniCode-v0.1.0-linux-x86_64.tar.gz')">Download tar.gz</button>
                    </div>
                    <div class="download-item">
                        <div class="download-item-header">
                        ...
                        <button class="btn primary" onclick="app.downloadFromGitHub('omnicode-darwin-aarch64.tar.gz','OmniCode-v0.1.0-macos-aarch64.tar.gz')">Download tar.gz</button>
                    </div>
                    <div class="download-item">
                ...
                <div id="section-mobile" style="display:${collapsedMobile ? 'none' : ''}">
                    ${isAndroid ? `
                        <div class="download-item">
                            ...
                            <button class="btn primary" onclick="app.downloadFromGitHub('omnicode-android.apk','omnicode-android.apk')">Download APK</button>
                        </div>
                    ` : isIOS ? `
                        <div class="download-item">
                            <div class="download-item-header">
    ...
    async downloadFromGitHub(assetName, filename) {
        const url = 'https://github.com/bomboclati/OmniCode-/releases/download/v0.1.0/' + assetName;
        this.showToast('Opening download: ' + filename);
